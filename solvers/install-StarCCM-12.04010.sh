...
wget -q http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+12.04.010_01_linux-x86_64.tar.gz -O $SHARE_DATA/INSTALLERS/STAR-CCM+12.04.010_01_linux-x86_64.tar.gz
...
echo export PATH=$SHARE_DATA/applications/12.04.010/STAR-CCM+12.04.010/star/bin:/opt/intel/impi/5.1.3.181/bin64:$PATH >> $SHARE_HOME/.bashrc
...
#rm -rf $SHARE_DATA/INSTALLERS/STAR-CCM+12.04.010_01_linux-x86_64.tar.gz
#rm $SHARE_DATA/*.tgz
